...
package Agpl.Optimization.Concorde is

   pragma Elaborate_Body;

   pragma Linker_Options ("-lconcorde");
   pragma Linker_Options ("-lqsopt");

   package C renames Interfaces.C;

   Log_Section : constant String := "agpl.optimization.concorde";
