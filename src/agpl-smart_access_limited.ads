...
generic
   ...
   Debug   : Boolean := False;          -- Log binding/free
package Agpl.Smart_access_Limited is

   pragma Preelaborate;

   Log_Section : constant String := "agpl.smart_access_limited";
...
private
   ...
   protected type Tracker_Type is
      ...
      procedure Adjust;
      procedure Finalize (Must_Free : out Boolean);
...
--     for Tracker_Access'Storage_Pool use Pool;
