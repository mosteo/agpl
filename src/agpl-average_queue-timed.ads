...
package Agpl.Average_queue.Timed is
   ...
   type Object (Slots : Positive; Slot_Duration : Positive)
   ...
   --  Says the avg/s (not over all the period covered by the gaps)
...
private
   ...
   type Object (Slots : Positive; Slot_duration : Positive) is
