...
------------------------------------------------------------------------------
--  $Id: agpl-streams-deflate.adb,v 1.1 2004/03/29 19:13:33 Jano Exp $

with Zlib.Streams.Extra;

-- with Text_Io;

package body Agpl.Streams.Deflate_Unbounded is
   ...
   -- Initialize                                                         --
   ------------------------------------------------------------------------
   procedure Initialize (This : in out Stream_Controller) is
   begin
...
--         Stream_Element_Count'Image (Available_Read (This)));
   ...
   -- Finalize                                                           --
   ------------------------------------------------------------------------
   procedure Finalize (This : in out Stream_Controller) is
   begin
