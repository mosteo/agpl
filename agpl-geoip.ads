...
private
   ...
   package IP_maps is new Charles.Maps.Sorted.Unbounded (
      Long_long_integer, Ip_entry, "<", "=");

   IP_table : IP_maps.Container_type;

   package Code_maps is new Charles.Maps.Sorted.Unbounded (
      Country_code, Ustring, "<", Agpl.Types.Ustrings.ASU."=");

   Code_table : Code_maps.Container_type;
